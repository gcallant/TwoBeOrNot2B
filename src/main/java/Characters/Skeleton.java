...
{
	public Skeleton(String name, int health, int strength, int dexterity, Armor armor, Weapon weapon, int percentageSpecial, int level)
	{
		super(name, health, strength, dexterity, ArmorType.Light, armor, WeaponType.Light, weapon, percentageSpecial, level);
	}
