...
public class MonsterFactory
{
    ...
    public A_Character createMonster(String monsterType, String monsterName)
    {
        switch(monsterType)
        {
            case "Goblin": return new Goblin(monsterName, 1/*50*/, 3, 10, new Cloth(1), new Dagger(1));
            case "Orc": return new Orc(monsterName, 1/*100*/, 5, 5, new Leather(1), new Sword(1));
            case "Ogre": return new Ogre(monsterName, 1/*200*/, 7, 3, new Leather(1), new Hammer(1));
        }
