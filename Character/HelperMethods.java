...
public class HelperMethods
{
	...
	public static void executePartyMenuChoice(Scanner kb, int choice, CharacterFactory factory)
	{
		...
		switch(choice)
		{
			...
			default:
				...
				numberOfMonsters = getValidNumber(kb, "\n\nPlease enter the number of %s you want: ", "monsters");
	...
	private static ArrayList<A_Character> createListOfCharacters(CharacterFactory factory, int numberInParty, Scanner kb)
	{
