...
public class MonsterFactory
{
    ...
    public A_Character createMonster(String monsterType, String monsterName, int level)
    {
        ...
        {
            case "Goblin":
//                return new Goblin(monsterName, 50, 3, 10, new Cloth(1), new Dagger(1), level);
                return new Goblin(monsterName, 1, 3, 10, new Cloth(1), new Dagger(1), level);
            case "Orc":
//                return new Orc(monsterName, 100, 5, 5, new Leather(1), new Sword(1), level);
                return new Orc(monsterName, 1, 5, 5, new Leather(1), new Sword(1), level);
            case "Ogre":
//                return new Ogre(monsterName, 200, 7, 3, new Leather(1), new Hammer(1), level);
